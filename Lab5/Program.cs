...
namespace Lab5
{
    ...
    {
        private const int COUNT_ELEMENTS = 30000;
        ...
        private static void Main(string[] args)
        {
            ...
            tables.ForEach(table =>
            {
                ...
                Console.WriteLine("Добавляем {0} элементов = {1}ms", COUNT_ELEMENTS, addTime);
                _sw.Reset();
                ...
                Console.WriteLine("Время доступа к элементу = {0}ms", containsTime);
                _sw.Reset();
